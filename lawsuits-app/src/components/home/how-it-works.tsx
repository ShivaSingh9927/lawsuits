...
export function HowItWorks() {
  return (
    <section className="bg-[#1A1512] py-32 text-white overflow-hidden border-y border-white/5">
      <div className="mx-auto max-w-screen-2xl px-12 lg:px-32">
        <div className="mb-24 flex flex-col items-center text-center">
          <motion.span
            ...
            viewport={{ once: true }}
            className="mb-6 block text-sm font-semibold uppercase tracking-[0.4em] text-accent-yellow bg-white/5 px-6 py-2"
          >
          ...
          <motion.h2
            ...
            className="font-serif text-5xl font-normal tracking-tight sm:text-6xl text-white"
          >
            How it works
          </motion.h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-20 lg:grid-cols-3">
          {steps.map((step, index) => (
            ...
            >
              <div className="mb-10 flex h-24 w-24 items-center justify-center rounded-full border border-white/5 bg-white/5 transition-transform hover:scale-110">
                <step.icon className="h-12 w-12 stroke-[1px] text-accent-yellow" />
              </div>
              <h3 className="mb-6 font-serif text-3xl font-normal tracking-tight text-white">
                {step.title}
              </h3>
